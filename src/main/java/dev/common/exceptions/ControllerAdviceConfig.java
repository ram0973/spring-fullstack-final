...
import dev.common.exceptions.dto.ApiExceptionResponseDto;
import dev.common.exceptions.dto.FieldViolation;
import dev.common.exceptions.dto.ValidationExceptionResponseDto;
...
public class ControllerAdviceConfig extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        return new ResponseEntity<>(new ApiExceptionResponseDto(getUrl(request), ex.getLocalizedMessage(), HttpStatus.UNSUPPORTED_MEDIA_TYPE), HttpStatus.UNSUPPORTED_MEDIA_TYPE);
    }

    @Override
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        return new ResponseEntity<>(new ApiExceptionResponseDto(getUrl(request), ex.getLocalizedMessage(), HttpStatus.UNPROCESSABLE_ENTITY), HttpStatus.UNPROCESSABLE_ENTITY);
    }
